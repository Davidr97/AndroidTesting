...
public class CalculatorInstrumentationTest {
    ...
    @Rule
    public ActivityTestRule<MainActivity> mAActivityRule = new ActivityTestRule<>(
            MainActivity.class);
    ...
    public void noOperandShowsComputationError() {
        ...
        onView(withId(R.id.main_activity_text_view)).check(matches(withText(expectedResult)));
    }
